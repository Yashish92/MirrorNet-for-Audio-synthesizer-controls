...
for i in range(3):  # 15 to 3
    ...
    trainTogether_newTechnique(epochs=5, name="train_D_"+str(i+1), init=False, train_D=True, train_E=False, loader_eval="train", save_better_model=False) #20 to 5
    trainTogether_newTechnique(epochs=5, name="train_E_"+str(i+1),init=False, train_D=False, train_E=True, loader_eval="train", save_better_model=False)
...
print("POST_TRAINING")
trainTogether_newTechnique(epochs=5, init=True, train_D=True, train_E=False, loader_eval="train", save_better_model=True) #100 to 5
