...
parser.add_argument('--train_data', type=str, default=base_dir + "music_data/train_audio.data",
                    help='path to training data')

parser.add_argument('--test_data', type=str, default=base_dir + "music_data/test_audio.data",
                    help='path to testing data')

parser.add_argument('--initialization_data', type=str, default=base_dir + "music_data/initialize_audio.data",
                    help='path to initialization data')

parser.add_argument('--train_random_data', type=str, default=base_dir + "music_data/train_audio_random.data",
...
for i in range(6):  # 15 to 3
    ...
    trainTogether_newTechnique(epochs=8, name="train_E_" + str(i + 1), init=False, train_D=False, train_E=True,
