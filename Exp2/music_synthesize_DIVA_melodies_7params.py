...
if __name__ == "__main__":
    audio_path = my_path + '/music_data_6params_new/test_audio_7params'
    param_path = my_path + '/music_data_6params_new/test_params_7params'
    ...
    for i in range(80):
        ...
        np.save(param_path + '/' + 'test_params_' + str(i), np.array([pitch, volume, duration, filterCutOff, filterReso, env_attack, env_decay]))
        ...
        generate([pitch, volume, duration, filterCutOff, filterReso, env_attack, env_decay], "train_audio_" + str(i), engine, generator, parameters,
                 rev_idx, pad=pad)
