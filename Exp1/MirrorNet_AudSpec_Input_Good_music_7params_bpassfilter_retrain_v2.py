...
class encoder(nn.Module):
    def __init__(self):
        ...
        self.music_seq = nn.Sequential(
            ...
            nn.AvgPool1d(2, stride=2),			# uncomment if melody length is 5 notes
            nn.Sigmoid()
...
class decoder(nn.Module):
    def __init__(self):
        ...
        self.L1 = nn.Sequential(
            ...
            nn.Upsample(scale_factor=2),		# uncomment if melody length is 5 notes
...
def generate_figures(mode="evaluation", name="", load_weights=("", "")):
    ...
    for batch_idx, data in enumerate(loader):
        ...
        for i in range(min(music.shape[0], 10)):
            ...
            ax2.set_yticklabels(params_labels)
            plt.colorbar()
            fig.tight_layout()
...
out = "figs/NEW_with_only_1_loss_for_DIVA_melodies_retr" + str(date.today()) + "_H_" + str(datetime.datetime.now().hour)
out_dir = "./figs/NEW_with_only_1_loss_for_DIVA_melodies_retr" + str(date.today()) + "_H_" + str(datetime.datetime.now().hour) + "/"

model_dir = "./figs/NEW_with_only_1_loss_for_DIVA_melodies_2021-09-11_H_14/"
...
parser.add_argument('--train_data', type=str,
                    default=base_dir + "music_data_6params_new/train_audio_7params_no_vib_new.data",
                    help='path to training data')

parser.add_argument('--test_data', type=str,
                    default=base_dir + "music_data_6params_new/test_audio_7params_no_vib_new.data",
